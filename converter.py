...
relations = {
    ...
    'cooking': 'cooking',
    'falling off': 'falling_off',
    'running through': 'running_through',
    'serving': 'serving',
    'splashing': 'splashing',
    'smelling': 'smelling',
...
complex_relations = {
    ...
    'parked along': (FilterRelation('activity', 'parked'),
                            relations['along']),
    'parked beside': (FilterRelation('activity', 'parked'),
                            relations['beside']),
    'parked by': (FilterRelation('activity', 'parked'),
                            relations['near']),
    ...
    'running in': (FilterRelation('activity', 'running'),
                    relations['in']),
    'walking by': (FilterRelation('activity', 'walking'),
                    relations['by']),
    ...
    'resting on': (FilterRelation('activity','resting'),
                    relations['on']),
    'swimming in': (FilterRelation('activity','swimming'),
                    relations['in']),
    'sleeping on': (FilterRelation('activity','sleeping'),
                    relations['on']),
    'walking up': (FilterRelation('activity','walking'),
                    relations['on']),
